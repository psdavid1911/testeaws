...
<html>
  <head>
    ...
    <!-- link rel="stylesheet" href="//cdn.jsdelivr.net/g/pure@1.0.0(base-min.css+grids-min.css+forms-min.css)" -->
    ...
    <script>
      ...
      function pegaAleatorio() {
          var xhttp = new XMLHttpRequest();
          xhttp.onreadystatechange = function () {
              if (this.readyState === 4 && this.status === 200) numeroAleatorio = this.responseText;
          };
  ...
  <body onload="showSlides();pegaAleatorio();">
    ...
    <div style="position:relative; display:block; left: 50%; width: 500px; margin-left: -250px;">
...
(30000/2)+(2^2)   N&uacute;mero de diversas casas
    ...
    <div style="text-align: center; margin-top: 1em; border-top: 2px black solid; position: relative; display: block; height: 10px; width: 100%;">
      <h1 style="text-align: center;">Mapa do site</h1><br>
      <br>
      <a style="text-align: center; text-decoration: none; color: black;" href="http://localhost:8084/laboratorio/">Home</a>
      <br>
      <a style="text-align: center; text-decoration: none; color: black;" href="https://psdavid1911.github.io/">P&aacute;gina pessoal</a>
      <br>
      <br>
    </div>
