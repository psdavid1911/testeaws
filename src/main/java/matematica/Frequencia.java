...
public class Frequencia< T extends Comparable<T>>{
     ...
     * @return
     */
    public double frequenciaAbsoluta(Lista8<T> conjunto,T elemento){
     ...
     * @return
     */
    public double frequenciaPercentual(Lista8<T> conjunto,T elemento){
        Frequency frequencia=new Frequency();
        for(T valor:conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public Lista8<T> moda(Lista8<T> conjunto){
        Frequency frequencia=new Frequency();
        Lista8<T> moda=new Lista8<T>();
        for(T valor:conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public double frequenciaAcumuladaAbsoluta(Lista8<T> conjunto,T elemento){
        Frequency frequencia=new Frequency();
        for(T valor:conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public double frequenciaAcumuladaPercentual(Lista8<T> conjunto,T elemento){
        Frequency frequencia=new Frequency();
        for(T valor:conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public double somaDasFrequencias(Lista8<T> conjunto){
        Frequency frequencia=new Frequency();
        for(T valor:conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public double numeroDeElementosDistintos(Lista8<T> conjunto){
        Frequency frequencia=new Frequency();
        for(T valor:conjunto)
            frequencia.addValue(valor);
