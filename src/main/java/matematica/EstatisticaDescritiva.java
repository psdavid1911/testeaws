...
public class EstatisticaDescritiva{
    public double mediaAritimetica(Lista8<Double> conjunto){
    ...
    public double mediaGeometrica(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public double mediaQuadratica(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public double desvioPadrao(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public double mediana(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
        return estatistica.getMean();
     ...
     */
    public double maximo(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     */
    public double minimo(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
    ...
    public long numeroDeTermos(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
    ...
    public double soma(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
    ...
    public double somaDosQuadrados(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public double varianciaDaAmostra(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
     ...
     * @return
     */
    public double varianciaDaPopulacao(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public double assimetria(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
    ...
    public Lista8<Double> valoresOrdenados(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        Lista8<Double> valores = new Lista8<Double>();
        for(Double valor : conjunto)
            estatistica.addValue(valor.doubleValue());
    ...
    public double percentil(Lista8<Double> conjunto, Double percentil){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public double curtose(Lista8<Double> conjunto){
        DescriptiveStatistics estatistica = new DescriptiveStatistics();
        for(Double valor : conjunto)
            estatistica.addValue(valor);
     ...
     * @return
     */
    public long frequenciaAbsoluta(Lista8<Double> conjunto, Numero elemento){
     ...
     * @return
     */
    public double frequenciaPercentual(Lista8<Double> conjunto, Numero elemento){
        Frequency frequencia = new Frequency();
        for(Double valor : conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public Lista8<Double> moda(Lista8<Double> conjunto){
        Frequency frequencia = new Frequency();
        Lista8<Double> moda = new Lista8<Double>();
        for(Double valor : conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public long frequenciaAcumuladaAbsoluta(Lista8<Double> conjunto, Numero elemento){
        Frequency frequencia = new Frequency();
        for(Double valor : conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public double frequenciaAcumuladaPercentual(Lista8<Double> conjunto, Double elemento){
        Frequency frequencia = new Frequency();
        for(Double valor : conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public long somaDasFrequencias(Lista8<Double> conjunto){
        Frequency frequencia = new Frequency();
        for(Double valor : conjunto)
            frequencia.addValue(valor);
     ...
     * @return
     */
    public int numeroDeElementosDistintos(Lista8<Double> conjunto){
        Frequency frequencia = new Frequency();
        for(Double valor : conjunto)
            frequencia.addValue(valor);
